...
(function($) {
    ...
    * ------------------------------------------------------ */
    const ssFinalCountdown = function() {
        ...
        const finalDate = '2020/07/06 08:30:00';

        $('.counter').countdown(finalDate)
        .on('update.countdown finish.countdown', function(event) {

            const str = '<div class=\"counter__time days\">%D&nbsp;<span>天</span></div>' +
                        '<div class=\"counter__time hours\">%H&nbsp;<span>時</span></div>' +
                        '<div class=\"counter__time minutes\">%M&nbsp;<span>分</span></div>' +
                        '<div class=\"counter__time seconds\">%S&nbsp;<span>秒</span></div>';
